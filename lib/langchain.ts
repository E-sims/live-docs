...
async function fetchMessagesFromDb(docId: string) {
  ...
  console.log(
    `--- Chat history fetched successfully: ${chatHistory.length} messages ---`
  )
...
const generateLangchainCompletion = async (docId: string, question: string) => {
  ...
  // Define a prompt templaet for answering questions based on retrieved context
  ...
  const historyAwareRetrievalPrompt = ChatPromptTemplate.fromMessages([
    ...
    ...chatHistory, // Insert chat history here
    ['user', '{input}'],
  ])
